...
//    }
//
//    // Date-picker для выбора следующего дня обслуживания
...
// InfoSectionCard, InfoRow, ReadOnlyInfoSection, EditableInfoSection,
// LocationCard, ServiceCard, UsersSection, ExpandableUserCard, InfoRowSmall
// остаются как в вашем оригинальном коде.
