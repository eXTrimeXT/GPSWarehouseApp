...
android {
    ...
    defaultConfig {
        ...
        minSdk = 30
        targetSdk = 36
        versionCode = 14        // 15 (текущая на сервере) -> 16 // - Обновление приложения происходит по этому параметру!!!
        versionName = "1.1.4"   // TEST v1.1.4 (текущая) -> v1.1.5
//        versionName = "1.0.1"   // PROD v1.0.2 (текущая) -> v1.0.3
